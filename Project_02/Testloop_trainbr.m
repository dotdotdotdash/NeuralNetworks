...
close all
%% EDITABLE VALUES
windowSize=15; % Number of data points in the input window
predictionSize=1; % Number of data points in the  output window
testSize=35; % Number of data points withheld for testing
Train.Algorithm='trainbr'; % Algorithm used for training {lm,br}
Train.Lrate=0.1; % Learning rate used in training
...
%     net{m}.trainParam.lr = Train.Lrate;
    ...
    net{m}.trainParam.min_grad = 1e-7;
